...
RUN apt-get update && apt-get install -y git curl sudo subversion wget unzip postgresql postgresql-contrib libpostgresql-jdbc-java && rm -rf /var/lib/apt/lists/*
